...
const InsideFlightSearchBar: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="p-4">
            <div className="flex flex-col w-[95%] mx-auto md:flex-row items-center justify-between">
                {/* Trip Type Selection */}
            ...
            <div className="grid grid-cols-5 gap-5">
                ...
                {/* Date Selection */}
                <div className="grid col-span-2 grid-cols-1 md:grid-cols-11 gap-2 md:gap-4 mb-4">
                    <input
                        type="date"
...
export default InsideFlightSearchBar;
