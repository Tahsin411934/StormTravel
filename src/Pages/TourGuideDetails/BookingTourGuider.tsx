...
export const BookingTourGuider = () => {
  ...
  const onSubmit = (formData: FormData) => {
    ...
    const totalAmount = calculateTotal(data?.price, formData.travelers);
    console.log(`Total Amount: ${totalAmount} BDT`);
  };

  const calculateTotal = (price: number | undefined, travelers: string) => {
    const numberOfTravelers = parseInt(travelers, 10);
    return price && !isNaN(numberOfTravelers)
      ? price * numberOfTravelers
      : 0;
  };
