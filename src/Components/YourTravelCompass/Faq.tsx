...
export const Faq = () => {
    return (
        <div>
            <div className=''>
                <h1 className='font-semibold text-xl mt-5 '>Most Common Questions</h1>
            </div>

            <div className="collapse collapse-plus bg-base-200 mb-3 mt-6">
                <input type="radio" name="my-accordion-3" defaultChecked />
                <div className="collapse-title  font-medium">What documents do I need for international travel?</div>
            ...
            <div className="collapse collapse-plus bg-base-200  mb-3">
                ...
                <div className="collapse-title  font-medium">How do I choose the best travel insurance?</div>
                <div className="collapse-content text-[13px]">
            ...
            <div className="collapse collapse-plus bg-base-200  mb-3">
                <input type="radio" name="my-accordion-3" />
                <div className="collapse-title  font-medium">What are the best tips for packing efficiently?</div>
                <div className="collapse-content text-[13px]">
            ...
            <div className="collapse collapse-plus bg-base-200  mb-3">
                <input type="radio" name="my-accordion-3" />
                <div className="collapse-title  font-medium">How can I find affordable flights?</div>
                <div className="collapse-content text-[13px]">
            ...
            <div className="collapse collapse-plus bg-base-200 mb-3">
                <input type="radio" name="my-accordion-3" />
                <div className="collapse-title  font-medium">What should I do if my luggage is lost?</div>
                <div className="collapse-content text-[13px]">
